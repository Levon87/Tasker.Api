...
namespace Auth.Service.Helpers
{
    public static class HashHelpers
    {
            ...
            string password)
        {
            ...
            var iterCount = 1000;
            var hashedPassword = Convert.ToBase64String(HashPasswordV3(password, rng,
            ...
            string password)
        {
            ...
            return VerifyHashedPasswordV3(decodedHashedPassword, password, out var iterCount);
        }
            ...
            out int iterCount)
        {
            ...
            try
            {
                ...
                Buffer.BlockCopy(hashedPassword, 13 + salt.Length, expectedSubkey, 0,
                    expectedSubkey.Length);

                // Hash the incoming password and verify it
                var actualSubkey =
                    KeyDerivation.Pbkdf2(password, salt, prf, iterCount, subkeyLength);
